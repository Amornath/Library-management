                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
								...
								<?php
									...
									{
										$qty=0;
										$res=mysqli_query($link,"select * from add_book where book_name='$_POST[booksname]'");
										while($row=mysqli_fetch_array($res))
										{
											$qty=$row["available"];
										}
										if($qty==0)
										{
											...
											<strong style="...">These books are not available in stock</strong>
											</div>
											<?php
										}
										else
										{
											mysqli_query($link,"insert into issue_books values('','$_SESSION[enrollmentno]','$_POST[studentname]','$_POST[studentsem]','$_POST[studentcontact]','$_POST[studentemail]','$_POST[booksname]','$_POST[bookissuedate]','','$_SESSION[username]')");
											mysqli_query($link,"update add_book set available=available-1 where book_name='$_POST[booksname]'");
											?>
												<script type="text/javascript">
