                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
										...
										<tr>
											<td>
												<select name="enr" class="form-control">
													<?php
														$res=mysqli_query($link,"select student_enrollment from issue_books where return_date=''");
								...
								<?php
									...
									{
										$res=mysqli_query($link,"select * from issue_books where student_enrollment='$_POST[enr]' && return_date=''");
										...
										echo "<th>"; echo "retrun book"; echo "</th>";
										echo "</tr>";
										while($row=mysqli_fetch_array($res))
										{
											echo "<tr>";
