...
<body class="login" style="margin-top: -20px;">
    ...
    <div class="login_wrapper">
			...
			$qry = "INSERT INTO student_registration( firstname, lastname, username, password, email, contact,semester,enrollmentno,status)
                  VALUES ('$firstname', '$lastname', '$username', '$password', '$email', '$contact','$semester','$enrollmentno','no')"; 
